...
%            shftRange = 0:2:10;
            ...
            while pt1 <= nCell1 && pt2 <= nCell2
                ...
                [err2, ob21, ob22] = cmpBlock(line1,smooth(line2,smoothLevel)', expFs, shftRange, mean(line1)-offLinePenalty);
                err1 = inf;
                while err2 < err1
                    dLink = [dLink pt2];
                    pt2 = pt2 + 1;
            ...
            while pt1 > 0 && pt2 > 0
                ...
                [err2, ob21, ob22] = cmpBlock(line1,line2cmp, expFs, shftRange, mean(line1)-offLinePenalty);
                err1 = inf;
                while err2 < err1
                    dLink = [pt2 dLink];
                    pt2 = pt2 - 1;
